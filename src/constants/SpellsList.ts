...
const SpellsList: TSpells[] = [
  ...
  { name: "Curse", spellocity: "target", actionType: "utility", range: '8"', fizzle: "Target strengthen all stats", weak: "Unfavorable stats", adequate: "Weaken all stats", exemplary: "Weaken and unfavorable all stats"},
  ...
  { name: "Telekinesis", spellocity: "d6", actionType: "utility", range: '6"', fizzle: "Target immobilized", weak: "Move target 6\"", adequate: "Move target 8\"", exemplary: "Move target 12\""},
  ...
  { name: "Discombobulate", spellocity: "target", actionType: "utility", range: '6"', fizzle: "Caster stunned", weak: "explosive, stun", adequate: "explosive, stun, daze", exemplary: "explosive stun, daze, disorient"},
  ...
  { name: "Zeta Beams", spellocity: "target", actionType: "combat", range: '6"', fizzle: "Caster takes 2 dmg", weak: "2dmg (up to 4 targets)", adequate: "3dmg (up to 4 targets)", exemplary: "4dmg (up to 4 targets)"},
